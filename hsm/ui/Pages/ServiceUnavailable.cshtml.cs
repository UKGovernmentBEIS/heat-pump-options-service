...
namespace OCC.HSM.UI.Pages
{
    ...
    /// </summary>
    public class ServiceUnavailableModel : HSMPage
	{
		private IConfiguration _configuration;

		/// <inheritdoc/>
		public ServiceUnavailableModel(IApplicationConfiguration configuration, ILogger logger, IConfiguration iConfig)
